...
def get_parse():
    ...
    for i in range(10000):
        ...
        print(i)
        print(s.proxies)
        url="https://m.weibo.cn/api/container/getIndex?uid=2769922841&luicode=10000011&lfid=100103type%3D1%26q%3D%E5%85%A8%E5%A8%B1%E4%B9%90%E7%8B%AC%E5%AE%B6&type=uid&value=2769922841&containerid=1076032769922841&page={}".format(str(i))
        print(url)
