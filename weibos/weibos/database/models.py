...
from sqlalchemy.dialects.mysql import INTEGER, MEDIUMTEXT, TINYINT,LONGTEXT,DATETIME
...
class Cookies(Base):
    ...
    create_time = Column(DATETIME(fsp=6), nullable=False, default=datetime.now)
